...
export default function Sidebar() {
  ...
  return (
    <motion.div
      ...
      className='group/sidebar flex flex-col h-dvh shrink-0 w-14 hover:w-52 transition-[width] duration-200 ease-in-out motion-reduce:transition-none overflow-hidden py-2 bg-ink-black text-steel-blue'
    >
      <nav
