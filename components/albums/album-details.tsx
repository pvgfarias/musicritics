  ...
  return (
    <div className='flex flex-row gap-4 w-full'>
      <div className='relative'>
        {!album.finalized && (
          <div className='flex flex-row justify-center items-center gap-2 absolute rounded-full border border-gray-300 dark:border-mist-600 bg-gray-50 dark:bg-mist-900  text-summer-blue shadow-sm font-mono z-30 top-2 right-2 px-1.5 py-0.5 text-[10px] '>
            <IconDisc size={14} />
            <h2>In Rotation</h2>
          </div>
        )}
