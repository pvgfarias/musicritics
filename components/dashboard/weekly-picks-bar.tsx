  ...
  return (
    <div className='flex flex-col w-1/3'>
      <div className='flex items-center gap-4 rounded-md border border-gray-300 dark:border-mist-600 bg-gray-50 dark:bg-mist-900 px-4 py-3 md:mx-0 mx-4 shadow-sm mb-4 font-mono'>
        ...
        <span className='hidden md:block whitespace-nowrap text-xs font-semibold uppercase tracking-wider text-amber-700 dark:text-amber-600'>
          ⏱ {daysLeft} day{daysLeft !== 1 ? 's' : ''} left
        </span>
      </div>
      <span className='md:hidden whitespace-nowrap text-xs font-semibold uppercase tracking-wider text-center text-amber-700 dark:text-amber-600'>
        ⏱ {daysLeft} day{daysLeft !== 1 ? 's' : ''} left
      </span>
    </div>
  );
